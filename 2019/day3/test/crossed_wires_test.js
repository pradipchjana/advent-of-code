...
import { findCoordinates,executeInstructions, findIntersections, findManhatanDistance, findTotalSteps } from "../src/crossed_wires.js";
...
Deno.test("find intersections| long data", () => {
  assertEquals(findTotalSteps("R8,U5,L5,D3","U7,R6,D4,L4"),30)
})

// Deno.test("find intersections| long data", () => {
//   const input = Deno.readTextFileSync("./data/input.txt").split("\n");
//   assertEquals(findTotalSteps(input[0],input[1]),164012)
// })