...
export const isIncreasing = (password) => {
...
export const hasAnyDublicateDigit = (password) => {
  ...
  for (let index = 0; index < password.length; index++) {
    countDuplicate[password[index]] = (countDuplicate[password[index]] || 0) +
      1;
  }
...
const isValid = (password) =>
  hasSixDigit(password) && isIncreasing(password) &&
  hasAnyDublicateDigit(password);
